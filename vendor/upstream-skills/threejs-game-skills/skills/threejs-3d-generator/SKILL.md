...
If installed in Codex instead of Codex, use:
...
```bash
python3 ~/.codex/skills/threejs-3d-generator/scripts/threejs_3d_asset.py text \
...
```bash
python3 ~/.codex/skills/threejs-3d-generator/scripts/threejs_3d_asset.py image \
...
```bash
python3 ~/.codex/skills/threejs-3d-generator/scripts/threejs_3d_asset.py status TASK_ID
python3 ~/.codex/skills/threejs-3d-generator/scripts/threejs_3d_asset.py download TASK_ID --out-dir assets/models
```

Texture, rig, animate, or convert:

```bash
python3 ~/.codex/skills/threejs-3d-generator/scripts/threejs_3d_asset.py postprocess \
...
```bash
python3 ~/.codex/skills/threejs-3d-generator/scripts/threejs_3d_asset.py character-pipeline \
