...
This folder is the quality assurance layer for the Codex Game Studio skill/agent
...
| File | Purpose |
|------|---------|
| `catalog.yaml` | Master registry for covered skills and agents. Contains category, spec path, and last-test tracking fields. Always read this first when running any test command. Extend it when adding coverage for new browser-family skills or agents. |
...
2. Read the skill at `.codex/skills/[name]/SKILL.md`
...
Codex Game Studio skills or agents themselves. `/skill-test` and `/skill-improve` will report that
