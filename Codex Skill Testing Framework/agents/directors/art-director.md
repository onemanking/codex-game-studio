...
**Model tier:** Standard (note: despite the "director" title, art-director is assigned Standard per coordination-rules.md — it handles individual system analysis, not multi-document phase gate synthesis at the Deep level).
...
- [ ] Model tier is `standard Codex model` (NOT Deep — coordination-rules.md assigns Standard to art-director)
