...
**Model tier:** Deep (multi-document synthesis, high-stakes architecture and phase gate verdicts).
...
- [ ] Model tier is `deep-reasoning Codex model` per coordination-rules.md (directors with gate synthesis = Deep)
