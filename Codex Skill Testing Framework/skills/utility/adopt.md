...
after explicit user approval via `Codex user-input prompt`.
...
- [ ] Contains "May I write" or `Codex user-input prompt` language before writing the adoption plan
...
8. Uses `Codex user-input prompt` to ask about writing the plan; user selects write
...
- [ ] `Codex user-input prompt` is used before writing the adoption plan
...
6. `Codex user-input prompt` asks to write the plan; writes after approval
...
- [ ] `Codex user-input prompt` is used before writing
...
6. `Codex user-input prompt` to write plan; writes after approval
...
3. Uses `Codex user-input prompt`:
...
**Assertions:**
- [ ] `Codex user-input prompt` is used (not a plain text message) when no artifacts are found
...
- [ ] Uses `Codex user-input prompt` before writing the adoption plan file
