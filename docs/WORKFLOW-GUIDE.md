# Codex Game Studio -- Complete Workflow Guide
...
become your go-to experts. If you pick Web Browser, `web-game-specialist`
routes the project to Phaser, Three.js, React Three Fiber, hybrid browser
architecture, and browser QA specialists.
...
| Web Browser architecture | `web-game-specialist` | 3 |
| Phaser browser games | `phaser-specialist` | 3 |
| Three.js/WebGL runtime | `threejs-specialist` | 3 |
| React Three Fiber apps | `r3f-specialist` | 3 |
| Browser runtime QA | `browser-qa-specialist` | 3 |
...
### Studio Workflow Commands by Category
