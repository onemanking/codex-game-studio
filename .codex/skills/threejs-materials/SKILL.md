...
description: >-
  Codex adaptation of CloudAI-X Three.js Skills skill 'threejs-materials'. Three.js materials - PBR, basic, phong, shader materials, material properties. Use when styling meshes, working with textures, creating custom shaders, or optimizing material performance.
---

# Generated by scripts/sync-upstream-skills.ps1

> Source: https://github.com/cloudai-x/threejs-skills
> Original skill name: threejs-materials
> Original source folder: vendor/upstream-skills/cloudai-threejs-skills/skills/threejs-materials
