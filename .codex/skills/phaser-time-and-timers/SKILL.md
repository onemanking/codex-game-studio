...
description: >-
  Codex adaptation of Phaser Skills skill 'time-and-timers'. Use this skill when using timers and time-based events in Phaser 4. Covers TimerEvent, delayed calls, looping timers, the Clock plugin, and time scaling. Triggers on: timer, delay, delayedCall, TimerEvent, Clock, time event.
---

# Generated by scripts/sync-upstream-skills.ps1

> Source: https://github.com/phaserjs/phaser/tree/master/skills
> Original skill name: time-and-timers
> Original source folder: vendor/upstream-skills/phaser/skills/time-and-timers
