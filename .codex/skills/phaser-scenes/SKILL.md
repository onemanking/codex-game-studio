...
name: phaser-scenes
description: >-
  Codex adaptation of Phaser Skills skill 'scenes'. Use this skill when working with Phaser 4 scenes. Covers scene lifecycle methods, scene transitions, parallel scenes, scene communication, sleeping, pausing, restarting, and the SceneManager. Triggers on: Scene, scene lifecycle, preload, create, update, scene transition, SceneManager.
---

# Generated by scripts/sync-upstream-skills.ps1

> Source: https://github.com/phaserjs/phaser/tree/master/skills
> Original skill name: scenes
> Original source folder: vendor/upstream-skills/phaser/skills/scenes
