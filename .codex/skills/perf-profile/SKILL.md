...
name: perf-profile
description: >-
  Codex Game Studio skill 'perf-profile'. Structured performance profiling workflow. Identifies bottlenecks, measures against budgets, and generates optimization recommendations with priority rankings.
---
