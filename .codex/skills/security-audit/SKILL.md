...
name: security-audit
description: >-
  Codex Game Studio skill 'security-audit'. Audit the game for security vulnerabilities: save tampering, cheat vectors, network exploits, data exposure, and input validation gaps. Produces a prioritised security report with remediation guidance. Run before any public release or multiplayer launch.
---
...
Spawn `security-engineer` via a Codex subagent. Pass:
