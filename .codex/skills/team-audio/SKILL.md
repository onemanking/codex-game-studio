...
name: team-audio
description: >-
  Codex Game Studio skill 'team-audio'. Orchestrate audio team: audio-director + sound-designer + technical-artist + gameplay-programmer for full audio pipeline from direction to implementation.
---
...
> Usage: `/team-audio [feature or area]` — specify the feature or area to design audio for (e.g., `combat`, `main menu`, `forest biome`, `boss encounter`). Do not use `Codex user-input prompt` here; output the guidance directly.
