...
description: >-
  Codex adaptation of Phaser Skills skill 'events-system'. Use this skill when working with the Phaser 4 event system. Covers EventEmitter, scene events, game events, custom events, and event-driven communication. Triggers on: events, on, emit, EventEmitter, scene events, listeners.
---

# Generated by scripts/sync-upstream-skills.ps1

> Source: https://github.com/phaserjs/phaser/tree/master/skills
> Original skill name: events-system
> Original source folder: vendor/upstream-skills/phaser/skills/events-system
