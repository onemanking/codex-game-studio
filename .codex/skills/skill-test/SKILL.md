...
name: skill-test
description: >-
  Codex Game Studio skill 'skill-test'. Validate skill files for structural compliance and behavioral correctness. Three modes: static (linter), spec (behavioral), audit (coverage report).
---
