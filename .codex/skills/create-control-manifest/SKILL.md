...
Spawn `technical-director` via a Codex subagent using gate **TD-MANIFEST** (`.codex/docs/director-gates.md`).
...
- **CONCERNS** → surface via `Codex user-input prompt` with options: `Revise flagged rules` / `Accept and proceed` / `Discuss further`
