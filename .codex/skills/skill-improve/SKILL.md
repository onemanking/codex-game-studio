...
name: skill-improve
description: >-
  Codex Game Studio skill 'skill-improve'. Improve a skill using a test-fix-retest loop. Runs static checks, proposes targeted fixes, rewrites the skill, re-tests, and keeps or reverts based on score change.
---
...
Verify `.codex/skills/[name]/SKILL.md` exists. If not, stop with:
...
Read the full skill file at `.codex/skills/[name]/SKILL.md`.
...
Ask: "May I write this improved version to `.codex/skills/[name]/SKILL.md`?"
...
Write the improved skill to `.codex/skills/[name]/SKILL.md`.
...
Ask: "May I revert `.codex/skills/[name]/SKILL.md` using git checkout?"
If yes: run `git checkout -- .codex/skills/[name]/SKILL.md`
