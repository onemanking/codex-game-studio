...
name: estimate
description: >-
  Codex Game Studio skill 'estimate'. Estimates task effort by analyzing complexity, dependencies, historical velocity, and risk factors. Produces a structured estimate with confidence levels.
---
