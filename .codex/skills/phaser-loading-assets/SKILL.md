...
description: >-
  Codex adaptation of Phaser Skills skill 'loading-assets'. Use this skill when loading assets in Phaser 4. Covers the Loader plugin, loading images, spritesheets, atlases, audio, JSON, tilemaps, bitmap fonts, and tracking load progress. Triggers on: preload, this.load, asset loading, spritesheet, atlas, load progress.
---

# Generated by scripts/sync-upstream-skills.ps1

> Source: https://github.com/phaserjs/phaser/tree/master/skills
> Original skill name: loading-assets
> Original source folder: vendor/upstream-skills/phaser/skills/loading-assets
