...
description: >-
  Codex Game Studio skill 'playtest-report'. Generates a structured playtest report template or analyzes existing playtest notes into a structured format. Use this to standardize playtest feedback collection and analysis.
---
...
After categorising findings, spawn `creative-director` via a Codex subagent using gate **CD-PLAYTEST** (`.codex/docs/director-gates.md`).
