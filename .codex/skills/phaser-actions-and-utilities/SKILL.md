...
description: >-
  Codex adaptation of Phaser Skills skill 'actions-and-utilities'. Use this skill when working with Phaser 4 utility functions, actions, alignment, grid layout, or batch operations on game objects. Triggers on: align, grid layout, actions, set operations on groups of game objects.
---

# Generated by scripts/sync-upstream-skills.ps1

> Source: https://github.com/phaserjs/phaser/tree/master/skills
> Original skill name: actions-and-utilities
> Original source folder: vendor/upstream-skills/phaser/skills/actions-and-utilities
