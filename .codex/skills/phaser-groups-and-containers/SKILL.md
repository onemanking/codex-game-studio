...
description: >-
  Codex adaptation of Phaser Skills skill 'groups-and-containers'. Use this skill when using Groups or Containers in Phaser 4. Covers organizing game objects, object pooling, batch operations, and nested transforms with Containers. Triggers on: Group, Container, object pool, getFirstDead, children.
---

# Generated by scripts/sync-upstream-skills.ps1

> Source: https://github.com/phaserjs/phaser/tree/master/skills
> Original skill name: groups-and-containers
> Original source folder: vendor/upstream-skills/phaser/skills/groups-and-containers
