...
description: >-
  Codex adaptation of Phaser Skills skill 'physics-matter'. Use this skill when using Matter.js physics in Phaser 4. Covers rigid bodies, constraints, composite bodies, sensors, collision filtering, world configuration, and advanced physics shapes. Triggers on: Matter, matter physics, constraint, joint, rigid body, sensor.
---

# Generated by scripts/sync-upstream-skills.ps1

> Source: https://github.com/phaserjs/phaser/tree/master/skills
> Original skill name: physics-matter
> Original source folder: vendor/upstream-skills/phaser/skills/physics-matter
