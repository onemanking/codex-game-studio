...
description: >-
  Codex adaptation of CloudAI-X Three.js Skills skill 'threejs-animation'. Three.js animation - keyframe animation, skeletal animation, morph targets, animation mixing. Use when animating objects, playing GLTF animations, creating procedural motion, or blending animations.
---

# Generated by scripts/sync-upstream-skills.ps1

> Source: https://github.com/cloudai-x/threejs-skills
> Original skill name: threejs-animation
> Original source folder: vendor/upstream-skills/cloudai-threejs-skills/skills/threejs-animation
