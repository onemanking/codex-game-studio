...
description: >-
  Codex adaptation of Three.js Game Skills skill 'threejs-debug-profiler'. Debug and profile Three.js browser games. Combines scene debugging, render/runtime/loading/animation/resize/mobile input fixes, performance profiling, draw calls, triangles, textures, memory, shader/post-processing cost, bundle size, and mobile DPR/input issues.
---

# Generated by scripts/sync-upstream-skills.ps1

> Source: https://github.com/majidmanzarpour/threejs-game-skills
> Original skill name: threejs-debug-profiler
> Original source folder: vendor/upstream-skills/threejs-game-skills/skills/threejs-debug-profiler
