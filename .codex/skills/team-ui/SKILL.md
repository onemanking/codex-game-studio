...
name: team-ui
description: >-
  Codex Game Studio skill 'team-ui'. Orchestrate the UI team through the full UX pipeline: from UX spec authoring through visual design, implementation, review, and polish. Integrates with /ux-design, /ux-review, and studio UX templates.
---
...
Then use `Codex user-input prompt` with options:
