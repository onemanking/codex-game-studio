...
description: >-
  Codex adaptation of Phaser Skills skill 'filters-and-postfx'. Use this skill when applying visual filters or post-processing effects in Phaser 4. Covers bloom, blur, glow, color matrix, barrel distortion, displacement, custom shaders, and the filter pipeline. Triggers on: filter, post-processing, shader, bloom, blur, glow, color effects.
---

# Generated by scripts/sync-upstream-skills.ps1

> Source: https://github.com/phaserjs/phaser/tree/master/skills
> Original skill name: filters-and-postfx
> Original source folder: vendor/upstream-skills/phaser/skills/filters-and-postfx
