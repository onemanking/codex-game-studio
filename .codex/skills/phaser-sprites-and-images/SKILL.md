...
description: >-
  Codex adaptation of Phaser Skills skill 'sprites-and-images'. Use this skill when creating Sprites or Images in Phaser 4. Covers factory methods, texture/frame selection, position, scale, rotation, tint, flip, alpha, origin, depth, and the component mixin system. Triggers on: Sprite, Image, this.add.sprite, this.add.image, texture, setTint, setAlpha.
---

# Generated by scripts/sync-upstream-skills.ps1

> Source: https://github.com/phaserjs/phaser/tree/master/skills
> Original skill name: sprites-and-images
> Original source folder: vendor/upstream-skills/phaser/skills/sprites-and-images
