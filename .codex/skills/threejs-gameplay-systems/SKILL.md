...
description: >-
  Codex adaptation of Three.js Game Skills skill 'threejs-gameplay-systems'. Build and iterate playable Three.js game systems. Combines starter scaffold creation, architecture, gameplay implementation, and game-feel tuning. Use for first playable slices, new Vite/TypeScript/Three.js game setup, game loops, entity systems, input, collision/physics, scoring, objectives, audio hooks, camera, controls, difficulty, feedback, and maintainable structure.
---

# Generated by scripts/sync-upstream-skills.ps1

> Source: https://github.com/majidmanzarpour/threejs-game-skills
> Original skill name: threejs-gameplay-systems
> Original source folder: vendor/upstream-skills/threejs-game-skills/skills/threejs-gameplay-systems
