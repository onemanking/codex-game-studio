...
Use this skill for shipped 3D assets, not runtime scene code. The default output format for browser 3D work in this template is GLB or glTF 2.0. The goal is predictable runtime assets, not whatever the DCC tool happened to export first.
