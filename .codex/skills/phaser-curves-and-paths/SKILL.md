...
description: >-
  Codex adaptation of Phaser Skills skill 'curves-and-paths'. Use this skill when working with curves and paths in Phaser 4. Covers splines, bezier curves, lines, ellipses, path followers, and mathematical curve types. Triggers on: curve, path, spline, bezier, path follower.
---

# Generated by scripts/sync-upstream-skills.ps1

> Source: https://github.com/phaserjs/phaser/tree/master/skills
> Original skill name: curves-and-paths
> Original source folder: vendor/upstream-skills/phaser/skills/curves-and-paths
