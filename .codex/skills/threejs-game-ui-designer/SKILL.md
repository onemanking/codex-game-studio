...
description: >-
  Codex adaptation of Three.js Game Skills skill 'threejs-game-ui-designer'. Design premium Three.js game UI. Use for HUDs, menus, overlays, pause/win/lose screens, settings, icon controls, touch UI, typography, responsive layout, safe areas, text fit, and UI/world cohesion.
---

# Generated by scripts/sync-upstream-skills.ps1

> Source: https://github.com/majidmanzarpour/threejs-game-skills
> Original skill name: threejs-game-ui-designer
> Original source folder: vendor/upstream-skills/threejs-game-skills/skills/threejs-game-ui-designer
