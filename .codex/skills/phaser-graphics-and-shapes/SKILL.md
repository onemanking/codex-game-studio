...
description: >-
  Codex adaptation of Phaser Skills skill 'graphics-and-shapes'. Use this skill when drawing shapes and graphics in Phaser 4. Covers the Graphics game object, lines, rectangles, circles, arcs, polygons, gradients, fill, stroke, and generated textures. Triggers on: Graphics, draw shape, fillRect, lineStyle, polygon, arc.
---

# Generated by scripts/sync-upstream-skills.ps1

> Source: https://github.com/phaserjs/phaser/tree/master/skills
> Original skill name: graphics-and-shapes
> Original source folder: vendor/upstream-skills/phaser/skills/graphics-and-shapes
