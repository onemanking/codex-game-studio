...
name: balance-check
description: >-
  Codex Game Studio skill 'balance-check'. Analyzes game balance data files, formulas, and configuration to identify outliers, broken progressions, degenerate strategies, and economy imbalances. Use after modifying any balance-related data or design. Use when user says 'balance report', 'check game balance', 'run a balance check'.
---
...
After presenting the report, use `Codex user-input prompt`:
