...
description: >-
  Codex adaptation of CloudAI-X Three.js Skills skill 'threejs-textures'. Three.js textures - texture types, UV mapping, environment maps, texture settings. Use when working with images, UV coordinates, cubemaps, HDR environments, or texture optimization.
---

# Generated by scripts/sync-upstream-skills.ps1

> Source: https://github.com/cloudai-x/threejs-skills
> Original skill name: threejs-textures
> Original source folder: vendor/upstream-skills/cloudai-threejs-skills/skills/threejs-textures
