...
name: phaser-tweens
description: >-
  Codex adaptation of Phaser Skills skill 'tweens'. Use this skill when animating properties over time in Phaser 4. Covers tweens, tween chains, easing functions, stagger, yoyo, repeat, callbacks, number tweens, and the TweenManager. Triggers on: tween, ease, animate, this.tweens.add, tween chain, stagger.
---

# Generated by scripts/sync-upstream-skills.ps1

> Source: https://github.com/phaserjs/phaser/tree/master/skills
> Original skill name: tweens
> Original source folder: vendor/upstream-skills/phaser/skills/tweens
