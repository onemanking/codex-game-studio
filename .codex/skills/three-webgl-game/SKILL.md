...
Use this skill for the default non-React 3D path in the template. This is not generic WebGL advice. It is an opinionated stack for browser 3D work:
...
Do not claim that this template offers equal 3D depth to the Phaser track. It supports serious 3D implementation, but the template is still 2D-first overall.
