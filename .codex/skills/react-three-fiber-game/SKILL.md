...
Use this skill when the 3D runtime lives inside a React application. This is the default React-native 3D path in the template and should be preferred over vanilla Three.js when the app shell, settings, storefront, editor surface, or surrounding product already uses React.
