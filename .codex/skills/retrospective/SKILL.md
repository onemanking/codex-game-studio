...
name: retrospective
description: >-
  Codex Game Studio skill 'retrospective'. Generates a sprint or milestone retrospective by analyzing completed work, velocity, blockers, and patterns. Produces actionable insights for the next iteration.
---
...
If a matching file is found, use `Codex user-input prompt`:
...
Then use `Codex user-input prompt` to present two options:
