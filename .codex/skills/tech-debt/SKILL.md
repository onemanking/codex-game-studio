...
name: tech-debt
description: >-
  Codex Game Studio skill 'tech-debt'. Track, categorize, and prioritize technical debt across the codebase. Scans for debt indicators, maintains a debt register, and recommends repayment scheduling.
---
...
Then use `Codex user-input prompt` to collect the **category**:
...
Then use `Codex user-input prompt` to collect the **estimated fix effort**:
