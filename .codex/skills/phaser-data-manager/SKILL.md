...
description: >-
  Codex adaptation of Phaser Skills skill 'data-manager'. Use this skill when using the Phaser 4 DataManager to store custom key-value data on game objects, listen for data change events, or manage game state. Triggers on: setData, getData, data events, custom data storage.
---

# Generated by scripts/sync-upstream-skills.ps1

> Source: https://github.com/phaserjs/phaser/tree/master/skills
> Original skill name: data-manager
> Original source folder: vendor/upstream-skills/phaser/skills/data-manager
