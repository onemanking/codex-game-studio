...
description: >-
  Codex adaptation of CloudAI-X Three.js Skills skill 'threejs-fundamentals'. Three.js scene setup, cameras, renderer, Object3D hierarchy, coordinate systems. Use when setting up 3D scenes, creating cameras, configuring renderers, managing object hierarchies, or working with transforms.
---

# Generated by scripts/sync-upstream-skills.ps1

> Source: https://github.com/cloudai-x/threejs-skills
> Original skill name: threejs-fundamentals
> Original source folder: vendor/upstream-skills/cloudai-threejs-skills/skills/threejs-fundamentals
