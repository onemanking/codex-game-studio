...
description: >-
  Codex adaptation of Phaser Skills skill 'audio-and-sound'. Use this skill when adding audio or sound to a Phaser 4 game. Covers loading audio, playing sounds, music, volume, spatial audio, Web Audio API, and SoundManager. Triggers on: sound, audio, music, volume, mute.
---

# Generated by scripts/sync-upstream-skills.ps1

> Source: https://github.com/phaserjs/phaser/tree/master/skills
> Original skill name: audio-and-sound
> Original source folder: vendor/upstream-skills/phaser/skills/audio-and-sound
