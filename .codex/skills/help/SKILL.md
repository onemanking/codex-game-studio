...
name: help
description: >-
  Codex Game Studio skill 'help'. Analyzes what is done and the users query and offers advice on what to do next. Use if user says what should I do next or what do I do now or I'm stuck or I don't know what to do
---
...
After reading the catalog, Glob `.codex/skills/*/SKILL.md` to get the full list
