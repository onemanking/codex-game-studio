...
name: bug-report
description: >-
  Codex Game Studio skill 'bug-report'. Creates a structured bug report from a description, or analyzes code to identify potential bugs. Ensures every bug report has full reproduction steps, severity assessment, and context.
---
