...
for Godot, Unity, Unreal, and Web Browser — each with dedicated
sub-specialists for major engine subsystems. Web Browser is treated as an
engine family covering Phaser, Three.js, React Three Fiber, and hybrid
browser-game stacks. All design agents and templates are grounded in
...
- **Tier 1 (Deep)**: Directors who make high-level decisions
...
- **Tier 2 (Standard)**: Department leads who own their domain
  - `game-designer`, `lead-programmer`, `art-director`, `audio-director`,
    `narrative-director`, `qa-lead`, `release-manager`, `localization-lead`

- **Tier 3 (Standard/Fast)**: Specialists who execute within their domain
...
| Get Web Browser game architecture advice | `web-game-specialist` |
...
| Build Phaser browser-game systems | `phaser-specialist` |
| Build Three.js/WebGL runtime systems | `threejs-specialist` |
| Build React Three Fiber scenes/apps | `r3f-specialist` |
| Validate browser runtime/playtest evidence | `browser-qa-specialist` |
