...
```
  ...
  Engine Specialists (use the SET matching your engine):
    ...
    web-game-specialist -- Web Browser lead: stack profiles, browser lifecycle, hybrid runtime boundaries
      phaser-specialist      -- Phaser: scenes, cameras, sprites, physics, tilemaps, DOM overlays
      threejs-specialist     -- Three.js: WebGL runtime, loaders, GLB/glTF, shaders, postprocessing
      r3f-specialist         -- React Three Fiber: React-hosted 3D, state boundaries, drei/physics
      browser-qa-specialist  -- Browser QA: dev server, console, screenshots, mobile, input/audio
```
...
| web-game-specialist | phaser-specialist, threejs-specialist, r3f-specialist, browser-qa-specialist |
...
| Browser runtime ownership conflict | web-game-specialist, then technical-director |
| Browser QA failure | browser-qa-specialist, then qa-lead |
