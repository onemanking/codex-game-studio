...
3. **Present 2-3 strategic options:**
   ...
   - *After the full analysis, use `Codex user-input prompt` to capture the decision*
...
Use the `Codex user-input prompt` tool to present strategic decisions as a selectable UI.
