...
2. **Ask architecture questions:**
   ...
   - *Use `Codex user-input prompt` to batch constrained architecture questions*
...
Use the `Codex user-input prompt` tool for architecture decisions and next-step choices.
